...
* Helm - Awesome interface for nearly everything
  Helm with some usefull defaults.
  #+BEGIN_SRC emacs-lisp
    (use-package helm
      :defer t
      :ensure t
      ...
      :config
      (require 'helm-config)
      (setq helm-split-window-in-side-p t            ; helm buffer in current buffer
            helm-move-to-line-cycle-in-source t      ; to end or beginning when reaching end of src
            helm-ff-search-library-in-sexp t         ; search for library in `require' and `declare-function' sexp.
            helm-scroll-amount 8                     ; scroll 8 lines other window using M-<next>/M-<prior>
            helm-ff-file-name-history-use-recentf t) ; search recent files
      (setq helm-swoop-speed-or-color t)             ; syntax highlighting for swoop
      (setq projectile-completion-system 'helm)      ; use helm for projectile
      (helm-mode)
      (helm-projectile-on)
      ; helm-maps don't work in the bind section
      (define-key helm-map (kbd "<tab>") 'helm-execute-persistent-action)
      (define-key helm-map (kbd "C-z" ) 'helm-select-action))
  #+END_SRC

  Use =helm= interface with =projectile=
  #+BEGIN_SRC emacs-lisp
...
* Common functions
  ...
  Use =helm-swoop= over multiple lines
  #+BEGIN_SRC emacs-lisp
...
* Javascript
  ...
  =company-tern= for auto complete
  #+BEGIN_SRC emacs-lisp
...
* Perl/Perl6
  ...
  #+BEGIN_SRC emacs-lisp
    (flycheck-define-checker my-perl
      ...
      :command ("/home/ben/perl5/perlbrew/perls/perl-5.24.0/bin/perl" "-w" "-c"
                (eval (let ((options '()))
...
* Search and Replace
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package anzu
      ...
      :bind (:map isearch-mode-map
                  ...
                  ("M-l" . anzu-isearch-query-replace-regexp))
      :config
  ...
  =helm swoop= for searching through buffer/s
  #+BEGIN_SRC emacs-lisp
    (use-package helm-swoop
      :ensure t
      :bind (("M-o" . helm-swoop)
             ("M-ö" . helm-swoop-multiline-4))
             ("M-ü" . helm-multi-swoop-all))
  #+END_SRC
...
* C/C++
  ...
  =company-irony= as backend for company
  #+BEGIN_SRC emacs-lisp
...
* Org
  ...
  (use-package org
    ...
    (setq org-reveal-root "file:///home/ben/src/reveal.js")
